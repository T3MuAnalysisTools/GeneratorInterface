#ifndef CustomThreeParticleFilter_h
#define CustomThreeParticleFilter_h
...
class CustomThreeParticleFilter : public edm::EDFilter {
 public:
  explicit CustomThreeParticleFilter(const edm::ParameterSet&);
  ~CustomThreeParticleFilter() override;
