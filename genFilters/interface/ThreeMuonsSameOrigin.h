#ifndef ThreeMuonsSameOrigin_h
#define ThreeMuonsSameOrigin_h
...
class ThreeMuonsSameOrigin : public edm::EDFilter {
 public:
  explicit ThreeMuonsSameOrigin(const edm::ParameterSet&);
  ~ThreeMuonsSameOrigin() override;
