#ifndef ThreeMuonsSameOriginExtended_h
#define ThreeMuonsSameOriginExtended_h
...
class ThreeMuonsSameOriginExtended : public edm::EDFilter {
 public:
  explicit ThreeMuonsSameOriginExtended(const edm::ParameterSet&);
  ~ThreeMuonsSameOriginExtended() override;
