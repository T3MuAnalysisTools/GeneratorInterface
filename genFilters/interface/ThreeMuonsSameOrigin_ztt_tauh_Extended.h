#ifndef ThreeMuonsSameOrigin_ztt_tauh_Extended_h
#define ThreeMuonsSameOrigin_ztt_tauh_Extended_h
...
class ThreeMuonsSameOrigin_ztt_tauh_Extended : public edm::EDFilter {
 public:
  explicit ThreeMuonsSameOrigin_ztt_tauh_Extended(const edm::ParameterSet&);
  ~ThreeMuonsSameOrigin_ztt_tauh_Extended() override;
