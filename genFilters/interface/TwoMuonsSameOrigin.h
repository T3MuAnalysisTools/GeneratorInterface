#ifndef TwoMuonsSameOrigin_h
#define TwoMuonsSameOrigin_h
...
class TwoMuonsSameOrigin : public edm::EDFilter {
 public:
  explicit TwoMuonsSameOrigin(const edm::ParameterSet&);
  ~TwoMuonsSameOrigin() override;
