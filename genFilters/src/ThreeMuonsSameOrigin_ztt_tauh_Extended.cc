#include "GeneratorInterface/genFilters/interface/ThreeMuonsSameOrigin_ztt_tauh_Extended.h"
#include "SimDataFormats/GeneratorProducts/interface/HepMCProduct.h"

ThreeMuonsSameOrigin_ztt_tauh_Extended::ThreeMuonsSameOrigin_ztt_tauh_Extended(const edm::ParameterSet& iConfig) :
  ...
  totalEvents_(0), passedEvents_(0)
{
  ...
  if ( (ptMin_.size() > 1 &&  particleID_.size() != ptMin_.size()) 
    ...
    edm::LogWarning("ThreeMuonsSameOrigin_ztt_tauh_Extended") << "WARNING: ThreeMuonsSameOrigin_ztt_tauh_Extended: size of PtMin, EtaMax, motherID, and/or Status does not match ParticleID size!" << std::endl;   
  }
...
ThreeMuonsSameOrigin_ztt_tauh_Extended::~ThreeMuonsSameOrigin_ztt_tauh_Extended()
{
...
bool ThreeMuonsSameOrigin_ztt_tauh_Extended::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void ThreeMuonsSameOrigin_ztt_tauh_Extended::endJob() {
  edm::LogInfo("ThreeMuonsSameOrigin_ztt_tauh_Extended") << "=== Results of ThreeMuonsSameOrigin_ztt_tauh_Extended: passed "
                                        << passedEvents_ << "/" << totalEvents_ << " events" << std::endl;
}

//define this as a plug-in
DEFINE_FWK_MODULE(ThreeMuonsSameOrigin_ztt_tauh_Extended);
